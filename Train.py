...
class GetDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ir = self.imageFolderDataset[index]
        vi = self.imageFolderDataset[index]
...
def main():
    ...
    folder_path =os.path.join(current_directory,"Dataset/train")
    training_dir_ir = os.path.join(folder_path, "MR T2", "*")
    training_dir_vi = os.path.join(folder_path, "SPECT", "*")

    folder_dataset_train_ir = glob.glob(training_dir_ir )

    folder_dataset_train_vi= glob.glob(training_dir_vi )
    # print("IR Dataset Paths:", folder_dataset_train_ir)
    # print("VI Dataset Paths:", folder_dataset_train_vi)
